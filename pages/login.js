      ...
      <main>
        <section className="relative w-full h-full py-40 min-h-screen">
          <div
            ...
            style={{
              backgroundImage:
                "url('https://images.unsplash.com/photo-1590248850529-a6638bb7bca6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1764&q=80')",
            }}
          ></div>
